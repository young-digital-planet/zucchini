package utopia.steps.asserts
{
	 ...
	 */
	public class AssertFillGapAddidionalDictionaryKeywordStep extends Step implements IAutomationStep
	{
		public static const NAME:String = 'assertFillGapAddidionalDictionaryKeyword';
		public static const PATTERN:RegExp = /I should see "{string}" in additional dictionary keyword/;
		...
		public function AssertFillGapAddidionalDictionaryKeywordStep(resolvedPattern:RegExp)
		{
		...
		public function execute(scriptName:String):void
		{
			...
			var keywordId:String = YDictionaryPagesFactory.KEYWORD_ID;
